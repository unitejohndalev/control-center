...
export const { setShowSideBarText, setShowSideBarTextFalse } = sideBarTextSlice.actions
...
export const { setShowOtherSideBarText1, setShowOtherSideBarText1False } = otherSideBarTextSlice1.actions
...
export const { setShowOthersSideBarText2, setShowOthersSideBarText2False } = othersSideBarTextSlice2.actions
...
export const { setShowHoverDashBoardText, setShowHoverDashBoardTextFalse } = hoverDashBoardTextSlice.actions
...
export const { setShowHoverUserText, setShowHoverUserTextFalse } = hoverUserTextSlice.actions
...
export const { setShowHoverProjectText, setShowHoverProjectTextFalse } = hoverProjectTextSlice.actions
...
export const { setShowHoverRoleText, setShowHoverRoleTextFalse } = hoverRoleTextSlice.actions
...
export const { setShowHoverOthersText, setShowHoverOthersTextFalse } = hoverOthersTextSlice.actions
