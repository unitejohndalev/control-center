...
const Sidebar: React.FC = () => {
  ...
  return (
    <div
      className={
        showSidebarText
          ? "h-[100vh] border-[.1rem] w-[13rem] px-5  flex flex-col gap-y-5 drop-shadow-lg shadow-sm rounded-md transition-all ease-linear "
          : "h-[100vh] border-[.1rem] w-[5.2rem] px-5  flex flex-col gap-y-5 drop-shadow-lg  shadow-sm rounded-md transition-all ease-linear "
      }>
      ...
      <div className="flex flex-col items-center w-full cursor-pointer gap-y-6">
        ...
        <div className="relative flex flex-col w-full gap-x-2">
          ...
          {showOtherSidebarText1 && (
            <div className="flex flex-col justify-center w-full  border-[.1rem] rounded-md shadow-sm px-2 py-2 mt-[1rem] gap-y-1">
          ...
          {showOtherSidebarText2 && (
            <div className="absolute left-[4rem] bg-white flex flex-col justify-center w-[11rem]  border-[.1rem] rounded-md shadow-sm px-2 py-2 gap-y-1">
              <p className="hover:bg-[#C9E7F9] py-[.1rem] px-[.15rem] rounded-md text-[.8rem]">
                Development Phase
              </p>
              <p className="hover:bg-[#C9E7F9] py-[.1rem] px-[.15rem] rounded-md text-[.8rem]">
